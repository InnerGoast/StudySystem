...
<div id="wrapper">
    ...
    <div class="box">
    	<table width="98%" class="tab">
            ...
            <!-- 迭代数据 -->
                 <c:forEach items="${pageBean.pageList}" var="notice">
    ...
    <!-- 判断总页数不等于1时，显示分页信息 -->
	    ...
	    <div align="center">
	           <c:if test="${pageBean.thisPage==1 }">
	                      【首页】
	    		【上一页】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.thisPage+1}" style="text-decoration:underline;color:blue;">下一页</a>】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.totalPage}" style="text-decoration:underline;color:blue;">尾页</a>】 
	           </c:if>
	           <c:if test="${pageBean.thisPage>1 && pageBean.thisPage<pageBean.totalPage }">
	                      【<a href="/City_info/managerServlet?thisPage=1" style="text-decoration:underline;color:blue;">首页</a>】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.thisPage-1}" style="text-decoration:underline;color:blue;">上一页</a>】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.thisPage+1}" style="text-decoration:underline;color:blue;">下一页</a>】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.totalPage}" style="text-decoration:underline;color:blue;">尾页</a>】 
	           </c:if>
	           <c:if test="${pageBean.thisPage==pageBean.totalPage }">
	                     【<a href="/City_info/managerServlet?thisPage=1" style="text-decoration:underline;color:blue;">首页</a>】
	    		【<a href="/City_info/managerServlet?thisPage=${pageBean.thisPage-1}" style="text-decoration:underline;color:blue;">上一页</a>】
	    		【下一页】
	    		【尾页】 
